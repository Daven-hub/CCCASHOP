  ...
  return (
    <div className='flex flex-col gap-6'>
      <div className='flex justify-between items-center'>
        <h1 className='flex items-center text-primary md:text-[1.7rem] font-bold gap-2.5'><FiPackage /> Stock des Produits </h1>
      ...
      <div className="bg-white flex flex-col gap-6 border rounded-[6px] p-7">
        <div className='flex justify-between items-center gap-4'>
            <h1 className='text-[1.6rem] font-bold text-primary'>Stock des produits</h1>
              ...
              {produits.length === 0 ? (
                ...
                produits.map((species, index) => (
                  <TableRow className="hover:bg-primary/10 cursor-pointer" key={index}>
                    ...
                    <TableCell><img className='w-10 h-10 object-contain rounded-[6px]' src={species?.image} alt={species?.id} /></TableCell>
