...
//   console.log('attributeValues', attributeValues)
  const valuesAttribute= attributeValues?.filter((y)=>y.idAttribute===attributeId?.idAttribute)
  const valuesSubCategorie= subcategories?.find((y)=>y.idsubcateg===attributeId?.idSubcategorie)
  const valuesCategorie= categories?.find((y)=>y.idcategorie===valuesSubCategorie?.idCategorie)
        ...
        <div className='flex gap-8'>
          <div className='w-[30%] flex flex-col h-fit gap-3 bg-white overflow-hidden border rounded-[6px]'>
            ...
            <div className="px-7 flex flex-col pt-6 gap-2.5 pb-7">
                <h2 className='text-2xl text-center border-b-2 font-semibold py-2.5'>{attributeId?.name}</h2>
                <div className='flex flex-col gap-2 font-medium pt-2'>
                    <div className='flex items-center justify-between'>
                        <span>Sous Catégorie :</span> <span>{valuesSubCategorie?.nom}</span>
                    </div>
                    <div className='flex items-center justify-between'>
