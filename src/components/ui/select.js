...
const SelectTrigger = forwardRef(({ className = "", children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={
      "flex h-10 w-full items-center justify-between rounded-md border border-input bg-background px-3 py-[1.4rem] text-sm ring-offset-background " +
...
const SelectItem = forwardRef(({ className = "", children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={
      "relative flex w-full hover:bg-gray-100 cursor-pointer items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none " +
