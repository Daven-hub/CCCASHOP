...
function PresentationLabel({ titre, Component }) {
      return (
            <div className='flex justify-end relative items-center h-[45px] px-8 bg-primary/5'>
                  <div className="absolute px-8 flex items-center bottom-0 left-0 w-[470px] h-[calc(100%+7px)] bg-primary/90 z-0
                                          ...
                                          after:border-r-transparent after:border-b-black/30">
                        <h2 className='text-[1.3rem] relative font-medium text-white'>{titre}</h2>
                  </div>
