      ...
      return (
            <>
                  <div className={`flex items-end gap-8 bg-primary px-[${paddingH}]`}>
                        <div className="w-[25%]">
                              <div className='bg-white relative rounded-t-[6px] text-black/75 flex items-center justify-between'>
                                    <div className='text-[.9rem] w-full rounded-t-[6px] justify-between py-3.5 px-5 border flex items-center font-bold gap-3.5'><span className="flex items-center gap-4"><Menu01Icon strokeWidth={2} size={21} /> Toutes les Catégories</span> <ArrowDown01Icon size={22} /></div>
                                    <ul className='absolute top-[calc(100%)] rounded-b-[6px] w-full bg-white left-0 flex border-x border-b border-t-0 text-gray-800 text-[.85rem] flex-col'>
                  ...
                  <div className={`flex gap-6 pt-6 px-[${paddingH}]`}>
                        ...
                        <div className="w-[75%] overflow-hidden shadow rounded-[6px] h-[475px]">
                              <img className='w-full h-full object-cover aspect-[4/4]' src='/produits/bann1.jpg' alt='p1' />
                        </div>
                  </div>
            </>
      )
