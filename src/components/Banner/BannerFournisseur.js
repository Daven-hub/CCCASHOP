...
function BannerFournisseur({ datas }) {
      // console.log(datas)
      return (
            <div className='h-[400px] relative rounded-[6px]'>
                  <img src={datas?.couvert} alt="banner" className='w-full object-top h-full object-cover rounded-[6px] absolute top-0 left-0' />
                  <div className='absolute bottom-0 h-[40%] left-0 px-[18.5%] flex flex-col gap-2 w-full bg-black/70 pt-4'>
                  ...
                  <div className='absolute bg-white p-4 rounded-full border bottom-[23%] left-[5%] flex items-center gap-4'>
